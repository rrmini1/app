      ...
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
        ...
        <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8">
          ...
          <a href="" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">Rrmini</span>
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <a class="nav-link fw-medium" aria-current="page" href="#">{{ __('navbar.home') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#">{{ __('navbar.features') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#">{{ __('navbar.team') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#">{{ __('navbar.faq') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-medium" href="#">{{ __('navbar.contact') }}</a>
            </li>
            <li class="nav-item mega-dropdown
  ">
              <a href="javascript:void(0);" class="nav-link fw-medium" aria-expanded="false" data-bs-toggle="mega-dropdown" data-trigger="hover">
