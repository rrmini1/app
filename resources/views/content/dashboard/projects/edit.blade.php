                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">{{__('project.add')}}</h5>
                            ...
                            <form action="{{ route('projects.users.store', $project ) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-4">
                                            <label for="smallSelect" class="form-label">{{__('project.selectDevelop')}}</label>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('projects.users.store', $project ) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-4">
                                            <label for="clientSelect" class="form-label">{{__('project.selectClient')}}</label>
